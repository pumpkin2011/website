...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { def_flg: @paper.def_flg, description: @paper.description, title: @paper.title }
    end
  ...
  test "should update paper" do
    patch :update, id: @paper, paper: { def_flg: @paper.def_flg, description: @paper.description, title: @paper.title }
    assert_redirected_to paper_path(assigns(:paper))
  end
